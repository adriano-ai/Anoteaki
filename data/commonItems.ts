...
export const commonItems = [
  "Arroz", "Feijão", "Açúcar", "Café", "Óleo", "Sal", "Macarrão", "Farinha de trigo", 
  "Leite", "Ovos", "Pão", "Margarina", "Manteiga", "Queijo", "Presunto", "Frango", 
  "Carne moída", "Alface", "Tomate", "Cebola", "Alho", "Batata", "Cenoura", "Banana", 
